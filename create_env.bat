...
C:\Users\marto\AppData\Local\Programs\Python\Python39\python.exe -m venv --clear venv_quant_course_v39
:: activate empty env
call .\venv_quant_course_v39\Scripts\activate
:: install required Python packages
pip install -r requirements.txt
C:\Users\marto\AppData\Local\Programs\Python\Python39\python.exe -m pip install --upgrade pip
